...
def proxy_handler(client_socket,remote_host,remote_port,receive_first):
    ...
    #receive data from remote first if opt set
    if receive_first:
...
def main():
    ...
    if len(sys.argv[1:]) !=5:
        print("Usage: ./proxy.py [localhost] [localport] [remotehosts] [remoteport] [receive_first]")
    ...
    #before sending to the remote target
